...
const translations: Translations = {
    ...
    ar: {
        ...
        'ZenFlow': 'زين فلو',
        'Luluma': 'لولوما',
        'SprintForce': 'سبرينت فورس',
        'PowerLift': 'باور ليفت',
        'YogaCo': 'يوغا كو',
        'Breathe': 'بريث',
        'FlowWear': 'فلو وير',
        'RunFast': 'رن فاست',
        'JoggingQueen': 'جوجينج كوين',
        'TrailBlazer': 'تريل بليزر',
        'LiftStrong': 'ليفت سترونج',
        'EliteGym': 'إيليت جيم',
        'FitnessWear': 'فيتنس وير',
        'BreatheEasy': 'بريث إيزي',
        'JoggerPro': 'جوجر برو',
        'SwiftRun': 'سويفت رن',
        'LiftMax': 'ليفت ماكس',
        'CasualFit': 'كاجوال فيت',
        'CalmSpirit': 'كالم سبيريت',
        'GreenFit': 'جرين فيت',
        'YogaSpirit': 'يوغا سبيريت',
        'ComfortWear': 'كومفورت وير',
        'CalmWear': 'كالم وير',
        'RunWear': 'رن وير',
        'RunMax': 'رن ماكس',
        'WeatherRun': 'ويذر رن',
        'ActiveMotion': 'أكتيف موشن',
        'TravelRunners': 'ترافل رنرز',
        'FitFlex': 'فيت فليكس',
        'GymWear': 'جيم وير',
        'WarmUp': 'وورم أب',
        'ActiveZone': 'أكتيف زون',
        'ZenFlex': 'زين فليكس',
        'ThermoFit': 'ثيرمو فيت',
        'FitBra': 'فيت برا',
        'GraphicFit': 'جرافيك فيت',
        'YogaSoul': 'يوغا سول',
        'Zen Spirit': 'زين سبيريت',
        'RunVibe': 'رن فايب',
        'RunPro': 'رن برو',
        'SprintRun': 'سبرينت رن',
        'OutdoorGear': 'أوت دور جير',
        'FlexFit': 'فليكس فيت',
        'PerformX': 'بيرفورم اكس',
        'StrengthWear': 'سترينث وير',
        'YogaBliss': 'يوغا بليس',
        'ActiveFit': 'أكتيف فيت',
        'ZenLife': 'زين لايف',
        'SmoothRun': 'سموث رن',
        'FlowFlex': 'فلو فليكس',
        'WearComfort': 'وير كومفورت',
        'RunnerGear': 'رونر جير',
    },
};
